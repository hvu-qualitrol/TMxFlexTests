...
{
    public class Xtr_Update_Test_Data : Abstract_Update_Test_Data
    {

        public Xtr_Update_Test_Data()
            : base()
        {
            HistoryDataTable = "TMflexXtrHistory";
            TestDataTable = "TMflexXtrTestData";
        ...
        {
            return GeneralizedTestData(testData, "XtrAssembly");
        }       
    }
}
