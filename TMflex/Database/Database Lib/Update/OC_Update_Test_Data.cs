...
{
    public class OC_Update_Test_Data : Abstract_Update_Test_Data
    {

        public OC_Update_Test_Data()
            : base()
        {
            HistoryDataTable = "TMflexOcHistory";
            TestDataTable = "TMflexOcTestData";
        ...
        {
            return GeneralizedTestData(testData, "OcAssembly");
        }       
    }
}
